...
MagiskDuo is a suite of open source software for customizing Android, specially designed for Surface Duo.<br>
...
- Clone sources: `git clone --recurse-submodules https://github.com/HikariCalyx/Magisk.git`
- Install Python 3.8+ \
